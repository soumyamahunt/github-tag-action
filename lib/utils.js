...
exports.mapCustomReleaseRules = exports.getLatestPrereleaseTag = exports.getLatestTag = exports.isPr = exports.getBranchFromRef = exports.getCommits = exports.getLastTag = exports.getValidTags = void 0;
...
function getLastTag() {
    return __awaiter(this, void 0, void 0, function* () {
        let tags = yield github_1.listTags();
        return tags[0];
    });
}
